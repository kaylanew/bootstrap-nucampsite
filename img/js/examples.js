...
var personName; //that data storage place will be henceforth known as personName`node
...
//One of the differences between var and let is that you can declare the same variable twice with var (bacleard practice)
var myPet = "Dog";
var myPet = "Cat";
